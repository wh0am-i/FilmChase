    ...
    <main className="font-mont w-screen h-screen bg-[#161616] flex">
        ...
        <div className="ml-8">
          ...
          <div className="text-[#A1A1A1] mt-14 border-b border-[#1F1F1F] py-4">
            ...
            <div className="mt-2 flex flex-col gap-2">
              <div className="bg-white flex items-center p-3 w-60 rounded-md gap-2 cursor-pointer">
                <img src="search.svg"></img>
                <p className="text-[#AC1A19] font-bold">Buscar</p>
              </div>
              <div className="flex gap-2 p-3 rounded-md cursor-pointer hover:bg-slate-800 transition-all">
      ...
      <div className="flex flex-col h-screen w-full p-6">
        <div className="flex w-full h-fit">
          <div className="flex items-center gap-2 w-full p-4 h-12 border-[#252525] border rounded-md">
            ...
            ></input>
            <img className="w-5 h-5" src="filter.svg"></img>
          </div>
        ...
        <div className="flex w-full h-full mt-4">
          {films.length == 0 ? (
            ...
            <div className="flex gap-3 flex-wrap">
              {films.map((film) => {
                return <FilmCard name={film.name} image={film.image}></FilmCard>;
              })}
            </div>
          )}
        </div>
